...
public class LiveTimePayViewerBusiness extends LivePayBusiness {
    ...
    private boolean isPreViewPlaying;//是否预览期间
    ...
    /**
     * @param actModel 是否预览期间
     */
    private void isPreViewPlaying(App_get_videoActModel actModel) {
        if (!TextUtils.isEmpty(actModel.getPreview_play_url())) {
