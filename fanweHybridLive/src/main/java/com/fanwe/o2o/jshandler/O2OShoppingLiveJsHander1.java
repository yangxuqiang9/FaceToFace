...
import com.fanwe.live.utils.MyCustomWebView;
...
public class O2OShoppingLiveJsHander1 extends ShopJsHandler {
    private SDDurationBlocker blocker = new SDDurationBlocker();
    private MyCustomWebView customWebView;

    public O2OShoppingLiveJsHander1(Activity activity) {
        super(activity);
    }

    public O2OShoppingLiveJsHander1(Activity activity, MyCustomWebView customWebView) {
        super(activity);
