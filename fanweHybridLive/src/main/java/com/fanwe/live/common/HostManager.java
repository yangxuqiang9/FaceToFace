...
public class HostManager {
    ...
    public void setServerUrl(String serverUrl) {
        hostModel.setServerUrl(serverUrl);
        hostModel.setApiUrl(serverUrl + ApkConstant.SERVER_URL_API_PATH);
        hostModel.save();
    }
    ...
    private void findAvailableHost(final SDResultCallback<String> callback) {
        ...
        if (hasPath) {
            ...
            params.setUrl(host + ApkConstant.SERVER_URL_API_PATH);
            params.putCtl("app");
            params.putAct("init");
        ...
        public static HostModel get() {
            try {
                ...
                if (SDPackageUtil.getVersionCode() > model.getVersionCode()) {
                    //app升级或者第一次安装
                    model.setServerUrl(ApkConstant.SERVER_URL);
