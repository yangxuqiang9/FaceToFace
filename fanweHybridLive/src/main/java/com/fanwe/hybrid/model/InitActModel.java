...
public class InitActModel extends BaseActModel
{
    ...
    private int bullet_screen_diamond = 1;// 弹幕一次消费的钻石
    ...
    private String diamond_name;//下发 钻石货币名称 参数名
    ...
    private String society_list_name;//公会名称
    ...
    private int open_send_diamonds_module;//是否开启赠送钻石功能
    private int open_diamond_game_module;//是否使用钻石作为游戏币，1表示是
    ...
    private int is_no_light; //1：不需要直播间点亮功能
    ...
    public void setShareInfo(ShareInfoModel shareInfo) {
        this.shareInfo = shareInfo;
    }

    public int getIs_no_light()
    {
        return is_no_light;
    }

    public void setIs_no_light(int is_no_light)
    {
        this.is_no_light = is_no_light;
    }
    ...
    private int game_distribution;//个人中心游戏分享收益
    ...
    public String getSociety_list_name()
    {
        return society_list_name;
    }

    public void setSociety_list_name(String society_list_name)
    {
        this.society_list_name = society_list_name;
    }
    ...
    public int getGame_distribution()
    {
        return game_distribution;
    }

    public void setGame_distribution(int game_distribution)
    {
        this.game_distribution = game_distribution;
    }
