...
public class SDVerticalScollView extends RelativeLayout
{
    ...
    public void setVerticalView(View verticalView)
    {
        ...
        verticalViewSizeListener.setView(verticalView).setCallback(new SDSizeChangedCallback<View>()
        {
    ...
    public void setHorizontalView(View horizontalView)
    {
        ...
        horizontalViewSizeListener.setView(horizontalView).setCallback(new SDSizeChangedCallback<View>()
        {
