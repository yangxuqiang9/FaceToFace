...
public class LiveLnvitationAwardActivity extends BaseTitleActivity  implements OnClickListener{
    ...
    private TextView tv_balance,tv_successful_invitation;
    ...
    private void initview(){
        ...
        tv_successful_invitation= (TextView) findViewById(R.id.tv_successful_invitation);
        ll_zhuanru= (LinearLayout) findViewById(R.id.ll_zhuanru);
        ll_copy= (LinearLayout) findViewById(R.id.ll_copy);
        ll_fenxiang= (LinearLayout) findViewById(R.id.ll_fenxiang);
        ll_tuandui= (LinearLayout) findViewById(R.id.ll_tuandui);
    ...
    private void bindData(LiveLnvitationAwardModel model){
        Log.i("LiveLnvitationAwardModel",model.toString());
        if(model ==null)
            return;
        tv_balance.setText(model.getYue());
        tv_successful_invitation.setText("你已成功邀请"+model.getRenshu()+"位好友,共充值￥"+model.getAll_money());
